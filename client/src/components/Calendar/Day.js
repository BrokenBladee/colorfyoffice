    ...
    return (
      ...
      <div className="bg-gray-400 rounded m-8 p-2 shadow-xl self-start">
        ...
        <div className="bg-gray-600 rounded shadow p-2 text-lg text-center ">
          ...
          <h2>{this.props.day.name} {this.props.day.date}</h2>
        </div>
        {/*A flexbox that contains the time and every entry of the window and the button to assign */}
        <div className="flex">       
          {/*A that contains the time */}
          <div className="bg-gray-600 rounded shadow p-2 mt-1 flex-grow self-start mr-2 text-sm min-w-9 max-w-9">8:00-12:00</div>
          ...
          <div className="flex flex-col bg-gray-600 rounded shadow p-2 mt-1 flex-grow flex-shrink min-h-1">
           ...
           <ABtn assignN={this.props.assignN}/>
          </div>
        </div>
        {/* Same as the Flexbox above */}
        <div className="flex">
          <div className="bg-gray-600 rounded shadow p-2 mt-1 flex-grow self-start mr-2 text-xs min-w-9 max-w-9">13:00-17:00</div>
